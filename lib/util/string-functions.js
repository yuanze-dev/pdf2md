...
exports.isNumber = function isNumber (string) {
  let hasNoWhiteSpace = exports.removeLeadingWhitespaces(string)
  hasNoWhiteSpace = exports.removeTrailingWhitespaces(hasNoWhiteSpace)
  for (var i = 0; i < hasNoWhiteSpace.length; i++) {
    const charCode = hasNoWhiteSpace.charCodeAt(i)
